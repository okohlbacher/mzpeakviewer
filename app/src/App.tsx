...
const NAV_ICON_PATHS: Record<View, string> = {
  ...
  study: "M5 4h14v16H5zM8 9h8M8 13h8M8 17h5",
...
function Sidebar() {
  ...
  const showStudyTab = useStore(showStudy);
  ...
  if (showStudyTab) allTabs.push("study");
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Study design — shown when the file carries study metadata (embedded SDRF /
            channels / sample list). ONE selector (showStudy) gates this tab, the Summary
            CTA and the view's empty state, so they can never disagree. */}
        {showStudyTab && (
          <TabButton id="study" label="Study design" data-testid="nav-tab-study" />
        )}
...
const VIEW_META: Record<View, { title: string; subtitle: string }> = {
  ...
  study: { title: "Study design", subtitle: "Sample annotations, experimental factors and channel map from the embedded SDRF" },
